jQuery(function ($) {
	...
	// Buy Now Btn
	$('body').append("<a href='https://themeforest.net/checkout/from_item/26776748?license=regular&support=bundle_6month&_ga=2.40494949.634514020.1646539215-1425290503.1590986634' target='_blank' class='buy-now-btn'><img src='assets/img/envato.png' alt='envato'/>Buy Now</a>");
...
function setTheme(themeName) {
    localStorage.setItem('restant_theme', themeName);
    document.documentElement.className = themeName;
}

// function to toggle between light and dark theme
function toggleTheme() {
    if (localStorage.getItem('restant_theme') === 'theme-dark') {
